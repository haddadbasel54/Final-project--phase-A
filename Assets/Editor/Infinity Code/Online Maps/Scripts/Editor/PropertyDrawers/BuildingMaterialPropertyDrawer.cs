...
{
    [CustomPropertyDrawer(typeof(BuildingMaterial))]
    public class BuildingMaterialPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            try
            {
                ...
                DrawProperty(property, "wall", ref rect, TempContent.Get("Wall Material"));
                DrawProperty(property, "roof", ref rect, TempContent.Get("Roof Material"));
