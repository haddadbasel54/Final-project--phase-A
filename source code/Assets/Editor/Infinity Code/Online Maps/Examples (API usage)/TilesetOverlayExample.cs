...
namespace OnlineMapsExamples
{
    ...
    public class TilesetOverlayExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (!material)
            {
                material = new Material(RenderPipelineHelper.GetTransparentShader());
        ...
        private void UpdateMesh()
        {
            ...
            float uvX1 = (float)(tr.left / maxTiles);
            float uvX2 = (float)(tr.right / maxTiles);

            if (uvX1 > uvX2) uvX2 += 1;

            float uvY1 = (float)(1 - tr.top / maxTiles);
            float uvY2 = (float)(1 - tr.bottom / maxTiles);
