...
namespace OnlineMaps.Webservices
{
    ...
    /// </summary>
    public class GooglePlacesNearbyRequest : GooglePlacesRequestBase
    {
        /// <summary>
        ...
        /// </param>
        public GooglePlacesNearbyRequest(double longitude, double latitude, int radius)
        {
        ...
        /// The maximum allowed radius is 50000 meters.
        /// </param>
        public GooglePlacesNearbyRequest(GeoPoint location, int radius)
        {
        ...
        /// </param>
        public GooglePlacesNearbyRequest(string pagetoken)
        {
        ...
        public override void AppendParams(StringBuilder builder)
        {
            ...
            if (rankBy.HasValue) builder.Append("&rankby=").Append(rankBy.Value);
        }
    }
}