...
namespace OnlineMaps.Webservices
{
    ...
    public class QQSearchResult
    {
        ...
        public static QQSearchResult Parse(string response)
        {
            return JSON.Deserialize<QQSearchResult>(response);
        }
        ...
        public class Location
        {
            ...
            public static implicit operator GeoPoint(Location location)
            {
