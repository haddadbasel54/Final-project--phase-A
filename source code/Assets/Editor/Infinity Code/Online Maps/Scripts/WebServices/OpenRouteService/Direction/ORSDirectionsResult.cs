...
namespace OnlineMaps.Webservices
{
    ...
    /// </summary>
    public class ORSDirectionsResult
    {
        /// <summary>
        /// Array of the routes
        /// </summary>
        ...
        public static ORSDirectionsResult Parse(string response)
        {
            return JSON.Deserialize<ORSDirectionsResult>(response);
        }
        ...
        public class Route
        {
            ...
            public List<GeoPoint> points
            {
                get
                {
                    if (geometry_format == "encodedpolyline" || geometry_format == null) return Utils.DecodePolylinePoints((string)geometry);
                    if (geometry_format == "polyline" || geometry_format == "geojson")
                    {
                        ...
                        List<GeoPoint> p = new List<GeoPoint>();
        ...
        {
            /// <summary>
            /// Surface information of the route.
            /// </summary>
            public ExtraItem surface;

            /// <summary>
            /// Way types information of the route.
            /// </summary>
            public ExtraItem waytypes;

            /// <summary>
            /// Steepness information of the route.
            /// </summary>
            public ExtraItem steepness;

            /// <summary>
            /// Suitability information of the route.
            /// </summary>
            public ExtraItem suitability;

            /// <summary>
            /// Way category information of the route.
            /// </summary>
