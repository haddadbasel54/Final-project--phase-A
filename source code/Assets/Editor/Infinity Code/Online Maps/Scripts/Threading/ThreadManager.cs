...
namespace OnlineMaps
{
    ...
    public class ThreadManager
    {
        ...
        private ThreadManager(Action action)
        {
#if !UNITY_WEBGL
            instance = this;
...
#else
            thread = new ThreadWINRT(StartNextAction);
#endif
            thread.Start();
#endif
        }
        ...
        /// <summary>
        /// Adds action queued for execution in the main thread.
        /// </summary>
        ...
        {
#if !UNITY_WEBGL
            if (instance == null) instance = new ThreadManager(action);
        ...
        /// <summary>
        /// Executes all actions queued for execution in the main thread.
        /// </summary>
        public static void ExecuteMainThreadActions()
        {
            lock (mainThreadActions)
            {
                ...
                else mainThreadActions.RemoveRange(0, i);
            }
        }
        ...
        private void StartNextAction()
        {
            ...
            while (isAlive)
            {
                ...
                if (!actionInvoked) Compatibility.ThreadSleep(1);
            }
