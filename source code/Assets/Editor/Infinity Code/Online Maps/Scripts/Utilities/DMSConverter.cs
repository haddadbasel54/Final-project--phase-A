...
namespace OnlineMaps
{
    ...
    /// </summary>
    public static class DMSConverter
    {
        /// <summary>
        ...
        {
            if (double.TryParse(dmsStr, NumberStyles.AllowDecimalPoint, Culture.numberFormat, out value)) return true;
            ...
            {
                case 3:
                    value = double.Parse(dmsArr[0], Culture.numberFormat) + double.Parse(dmsArr[1], Culture.numberFormat) / 60 +  double.Parse(dmsArr[2], Culture.numberFormat) / 3600;
                    break;
                case 2:
                    value = double.Parse(dmsArr[0], Culture.numberFormat) + double.Parse(dmsArr[1], Culture.numberFormat) / 60;
                    break;
                case 1:
                    value = double.Parse(dmsArr[0], Culture.numberFormat);
                    break;
                default:
                    value = double.NaN;
                    return false;
        ...
        private static string ToDMS(double deg, string format = null, int dp = -1)
        {
            ...
            switch (format)
            {
                default:
                    d = Math.Round(deg, dp);
                    sd = d.ToString(Culture.numberFormat);
                    if (d < 100) sd = "0" + sd;
                    if (d < 10) sd = "0" + sd;
                    dms = sd + "°";
                    break;
                ...
                case "deg+min":
                    ...
                    sm = m.ToString(Culture.numberFormat);
                    if (d < 100) sd = "0" + sd;
                    if (d < 10) sd = "0" + sd;
                    if (m < 10) sm = "0" + sm;
                ...
                case "deg+min+sec":
                    ...
                    string ss = s.ToString(Culture.numberFormat);
                    if (d < 100) sd = "0" + sd;
                    if (d < 10) sd = "0" + sd;
                    if (m < 10) sm = "0" + sm;
                    if (s < 10) ss = "0" + ss;
