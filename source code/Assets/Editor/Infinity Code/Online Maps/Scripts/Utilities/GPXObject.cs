...
namespace OnlineMaps
{
    ...
    public class GPXObject
    {
        ...
        public GPXObject(string creator, string version = "1.1"): this()
        {
        ...
        public static GPXObject Load(string content)
        {
            GPXObject instance = new GPXObject();

            try
            {
                XML xml = XML.Load(content);

                instance.version = xml.A("version");
                instance.creator = xml.A("creator");

                foreach (XML n in xml)
                {
        ...
        /// <summary>
        /// Returns XML, contains full information about GPX Object.
        /// </summary>
        /// <returns>Instance of XML.</returns>
        public XML ToXML()
        {
            XML xml = new XML("gpx");
        ...
        public class Copyright
        {
            ...
            public void AppendToNode(XML node)
            {
        ...
        public class Bounds
        {
            ...
            {
                get { return _minlat; }
                set { _minlat = Mathd.Clamp(value, -90, 90); }
            }
            ...
            {
                get { return _minlon; }
                set { _minlon = Mathd.Repeat(value, -180, 180); }
            }
            ...
            {
                get { return _maxlat; }
                set { _maxlat = Mathd.Clamp(value, -90, 90); }
            }
            ...
            {
                get { return _maxlon; }
                set { _maxlon = Mathd.Repeat(value, -180, 180); }
            }
        ...
        public class TrackSegment
        {
            ...
            public TrackSegment(XML node): this()
            {
                foreach (XML n in node)
                {
        ...
        public class Waypoint
        {
            ...
            {
                get { return _lat; }
                set { _lat = Mathd.Clamp(value, -90, 90); }
            }
            ...
            {
                get { return _lon; }
                set { _lon = Mathd.Repeat(value, -180, 180); }
            }
            ...
            public double? magvar
            {
                ...
                set
                {
                    if (value.HasValue) _magvar = Mathd.Clamp(value.Value, 0, 360);
                    else _magvar = null;
                }
            }
