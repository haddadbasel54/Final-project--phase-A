...
namespace OnlineMaps
{
    ...
    public static class InputManager
    {
        ...
        /// <summary>
        /// Allows you to change the returned position of the input.
        /// </summary>
        public static Func<Vector2> OnGetInputPosition;
        ...
        /// <summary>
        /// Allows you to change the returned positions of multitouch input.
        /// </summary>
        public static Func<Vector2[]> OnGetMultitouchInputPositions;

        /// <summary>
        /// Allows you to change the returned touch count.
        /// </summary>
        public static Func<int> OnGetTouchCount;
        ...
        {
            get => OnGetInputPosition != null ? OnGetInputPosition() : GetRawInputPosition();
        }
...
#else
#if UNITY_EDITOR
                return UnityEditor.EditorApplication.isRemoteConnected || Input.touchSupported;
#else
        ...
        /// <summary>
        /// Returns the raw input position of the mouse or touch.
        /// </summary>
        /// <returns>The raw input position as a Vector2.</returns>
        public static Vector2 GetRawInputPosition()
        {
#if USE_NEW_INPUT
            if (touchSupported)
            {
            ...
            if (float.IsInfinity(p.x)) return Vector2.zero;
            return p;
#endif
        }

        /// <summary>
        /// Returns the raw state of the specified mouse button.
        /// Uses the new input system if enabled, otherwise falls back to the legacy input manager.
        /// </summary>
        /// <param name="button">Mouse button index (0 - left, 1 - right, 2 - middle)</param>
        /// <returns>True if the button is pressed, otherwise false.</returns>
        public static bool GetRawMouseButton(int button)
        {
#if USE_NEW_INPUT
            Mouse mouse = Mouse.current;
        ...
        /// <summary>
        /// Returns the raw touch count from the input system.
        /// Uses the new input system if enabled, otherwise falls back to the legacy input manager.
        /// </summary>
        /// <returns>The number of active touches detected by the input system.</returns>
        public static int GetRawTouchCount()
        {
            if (!touchSupported) return 0;
